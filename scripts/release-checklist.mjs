...
function buildBody(version) {
  return [
    ...
    '- [ ] If `website/**` changed, run `Deploy Website` workflow and verify live URL',
    '- [ ] Owner DM `!release preview ...` reviewed and member-facing message approved',
    '- [ ] Owner DM `!release send ...` broadcast sent to affected groups only',
