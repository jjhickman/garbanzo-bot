...
const canonicalEnv = {
  ...
  TELEGRAM_BOT_TOKEN: 'test_telegram_bot',
  TELEGRAM_OWNER_ID: '123456789',
  TELEGRAM_CHATS_CONFIG_PATH: 'config/test-telegram-chats.json',
  DB_DIALECT: 'postgres',
  ...
  BRIDGE_MAX_TEXT: '800',
  BRIDGE_MEDIA_ENABLED: 'true',
  BRIDGE_MEDIA_MAX_BYTES: '10000000',
  ...
  it('preserves the parsed config key set and representative values', async () => {
    ...
    expect({
      ...
      bridge: {
        ...
        mediaMaxBytes: config.BRIDGE_MEDIA_MAX_BYTES,
